...
void HAL_EVE_Init()
{
	...
	DEBUG_PUTS("Set Chip Select OFF");
	HAL_ChipSelect(0);

	DEBUG_PUTS("Reset the display");
	MCU_Delay_20ms();
	HAL_PowerDown(1);
	MCU_Delay_20ms();
	HAL_PowerDown(0);
